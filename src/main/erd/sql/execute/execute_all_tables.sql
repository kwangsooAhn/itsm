...
insert into awf_url values ('/cmdb/cis', 'get', 'CMDB CI 조회 화면', 'FALSE');
...
insert into awf_url_auth_map values ('/cmdb/cis', 'get', 'form.read');
insert into awf_url_auth_map values ('/cmdb/cis', 'get', 'form.update');
