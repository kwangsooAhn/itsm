...
insert into awf_menu values ('config.product', 'config', '/products/view', 7,TRUE);
...
insert into awf_url values ('/products/view', 'get', '제품 정보 상세 조회', 'TRUE');
...
insert into awf_url_auth_map values ('/products/view', 'get', 'product.read');
