...
insert into awf_url values ('/rest/tokens/cis/{id}/data', 'put', 'CI 컴포넌트 - CI 세부 정보 등록 / 수정', 'FALSE');
...
insert into awf_url_auth_map values ('/rest/tokens/cis/{id}/data', 'put', 'form.read');
insert into awf_url_auth_map values ('/rest/tokens/cis/{id}/data', 'put', 'form.update');
