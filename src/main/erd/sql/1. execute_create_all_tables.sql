 ...
 * 2020-07-17 kbh
 *   1) 실행전 시퀀스 먼저 돌려라
 *   2) 테이블 및 제약 조건 sql을 모아둠. 이거만 돌리면 기본 테이블 및 데이터는 셋팅된다.
 *   3) 시퀀스는 별도의 sql로 만들어져 있다.
 *   4) 현재 테이블 총 개수. 자세한건 ermaster plugin으로 erd를 참고할 것. 
 *     - awf 테이블 30개 + wf 테이블 16개 = 총 합계 테이블 46개
 */
...
insert into awf_user values ('0509e09412534a6e98f04ca79abb6424', 'admin', 'ADMIN', '$2a$10$QsZ1uzooTk2yEkWIiV8tyOUc/UODpMrjdReNUQnNWm0SpjyPVOy26', 'admin@gmail.com', TRUE, 0, now() + interval '3months', null, null, 'KEAKvaudICgcbRwNaTTNSQ2XSvIcQyTdKdlYo80qvyQjbN5fAd', 'user.status.certified', null, null, 'user.platform.alice', 'Asia/Seoul', null, 'ko', 'yyyy-MM-dd HH:mm', 'default', '0509e09412534a6e98f04ca79abb6424', now(), null, null);
/***********************************************************************************************************************/
/************** awf_user_role_map                                  *************/
/**
 * 사용자역할매핑
...
(
	...
	faq_titile varchar(512) NOT NULL,
...
COMMENT ON COLUMN portal_faq.faq_titile IS 'FAQ 제목';
