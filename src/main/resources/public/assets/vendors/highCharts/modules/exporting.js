...
(function (a) {
        ...
        function (a, b, r, h) {
            ...
            h = function () {
                ...
                a.prototype.close = function () {
                    var c = this.chart, a = c.options.chart;
                ...
                a.prototype.open = function () {
                    var c = this, a = c.chart, e = a.options.chart;
                ...
                a.prototype.setButtonText = function () {
                    var a = this.chart, b = a.exportDivElements, e = a.options.exporting,
    ...
    g(a, "Mixins/Navigation.js", [], function () {
        return {
            initUpdate: function (a) {
                ...
                b.navigation.updates.push({update: a, context: b})
            }
        }
    });
    g(a, "Extensions/Exporting/ExportingDefaults.js", [a["Core/Globals.js"], a["Core/Color/Palette.js"]], function (a, b) {
        return {
            ...
            navigation: {
                ...
                menuStyle: {border: "1px solid " + b.neutralColor40, background: b.backgroundColor, padding: "5px 0"},
                menuItemStyle: {
                    padding: "0.5em 1em",
                ...
                menuItemHoverStyle: {background: b.highlightColor80, color: b.backgroundColor}
            }
        }
    });
        ...
        var m = a.doc, h = b.createElement, g = b.discardElement,
            F = b.merge, c = b.objectEach, G = {
                ajax: function (a) {
                    ...
                    G.ajax({url: a, success: b, dataType: "json", headers: {"Content-Type": "text/plain"}})
                }, post: function (a, b, r) {
                    var e = h("form", F({
                        method: "post",
                        action: a,
                        enctype: "multipart/form-data"
                    }, r), {display: "none"}, m.body);
                    c(b, function (a, b) {
                        h("input", {
                            type: "hidden",
                            name: b, value: a
    ...
    g(a, "Extensions/Exporting/Exporting.js", [a["Core/Renderer/HTML/AST.js"], a["Core/Chart/Chart.js"], a["Mixins/Navigation.js"], a["Core/DefaultOptions.js"], a["Extensions/Exporting/ExportingDefaults.js"], a["Extensions/Exporting/ExportingSymbols.js"], a["Core/Globals.js"], a["Core/HttpUtilities.js"], a["Core/Color/Palette.js"], a["Core/Utilities.js"]], function (a, b, g, h, z, F, c, G, e, k) {
        h = h.defaultOptions;
        var m = c.doc, r = c.win, t = k.addEvent, u = k.css, A = k.createElement,
            I = k.discardElement, B = k.extend, O = k.find, C = k.fireEvent, P = k.isObject, p = k.merge,
            J = k.objectEach, v = k.pick, Q = k.removeEvent, R = k.uniqueKey, D;
        (function (h) {
            function z(a) {
                var d = this, b = d.renderer, l = p(d.options.navigation.buttonOptions, a), c = l.onclick,
                    x = l.menuItems, m = l.symbolSize || 12;
                d.btnCount || (d.btnCount = 0);
                d.exportDivElements || (d.exportDivElements = [], d.exportSVGElements = []);
                if (!1 !== l.enabled && l.theme) {
                    var f = l.theme, y = f.states, h = y && y.hover;
                    y = y && y.select;
                    var k;
                    ...
                    if (l.symbol) {
                        var r = b.symbol(l.symbol, l.symbolX - m / 2, l.symbolY - m / 2, m, m, {
                            width: m,
                            height: m
                        }).addClass("highcharts-button-symbol").attr({zIndex: 1}).add(q);
                        d.styledMode || r.attr({
                    ...
                    q.add(d.exportingGroup).align(B(l, {width: q.width, x: v(l.x, d.buttonOffset)}), !0, "spacingBox");
            ...
            function D() {
                if (this.printReverseInfo) {
                    var a = this.printReverseInfo, w = a.childNodes, b = a.origDisplay;
                    a = a.resetParams;
            ...
            function S() {
                var a = m.body, b = this.options.exporting.printMaxWidth,
            ...
            function U(d, b, c, l, e, x, h) {
                var f = this, w = f.options.navigation, H = f.chartWidth, K = f.chartHeight, q = "cache-" + d,
                    g = Math.max(e,
                        x), n = f[q];
                if (!n) {
                    f.exportContextMenu = f[q] = n = A("div", {className: d}, {
                        position: "absolute",
                        zIndex: 1E3,
                        padding: g + "px",
                        pointerEvents: "auto"
                    }, f.fixedDiv || f.container);
                    var p = A("ul", {className: "highcharts-menu"}, {listStyle: "none", margin: 0, padding: 0}, n);
                    f.styledMode || u(p, B({
                    ...
                    b.forEach(function (d) {
                        ...
                        if (P(d, !0)) {
                            ...
                            }, u(b, B({cursor: "pointer"}, w.menuItemStyle))));
                ...
                u(n, b);
                u(f.renderTo, {overflow: ""});
                u(f.container, {overflow: ""});
                f.openMenu = !0;
                C(f, "exportMenuShown")
            }

            function V(a) {
                var d = a ? a.target : this, b = d.exportSVGElements, c = d.exportDivElements;
                a = d.exportEvents;
                var e;
            ...
            function Z(a) {
                ...
                }, m.body), h = this.renderTo.style.width;
                ...
                k = c.exporting.sourceHeight || c.chart.height || /px$/.test(k) && parseInt(k, 10) ||
                    400;
                B(c.chart, {animation: !1, renderTo: e, forExport: !0, renderer: "SVGRenderer", width: h, height: k});
                ...
                this.axes.forEach(function (a) {
                    ...
                    a.options.isInternal || (g[a.coll] || (g[a.coll] = !0, c[a.coll] = []), c[a.coll].push(p(a.userOptions, {visible: a.visible})))
                });
            ...
            function aa(a,
                ...
                return this.getSVG(p({chart: {borderRadius: 0}}, d.chartOptions, b, {
                    exporting: {
            ...
            function ba() {
                function a(d) {
                    ...
                    if (1 === d.nodeType && -1 === ca.indexOf(d.nodeName)) {
                        ...
                        if (c.isFirefox ||
                            c.isMS) for (var v in n) f(n[v], v); else J(n, f);
                ...
                var b = da, e = h.inlineWhitelist, l = {}, k, g = m.createElement("iframe");
                u(g, {width: "1px", height: "1px", visibility: "hidden"});
            ...
            function ia() {
                var a = this, b = a.options.exporting, c = b.buttons, e = a.isDirtyExporting || !a.exportSVGElements;
                a.buttonOffset = 0;
                a.isDirtyExporting && a.destroyExport();
                e && !1 !== b.enabled && (a.exportEvents = [], a.exportingGroup = a.exportingGroup || a.renderer.g("exporting-group").attr({zIndex: 3}).add(), J(c, function (b) {
                    a.addButton(b)
            ...
            h.inlineWhitelist =
                [];
            var ca = ["clipPath", "defs", "desc"], E;
            h.compose = function (a, b) {
                F.compose(b);
                -1 === N.indexOf(a) && (N.push(a), b = a.prototype, b.afterPrint = D, b.exportChart = W, b.inlineStyles = ba, b.print = ha, b.sanitizeSVG = ja, b.getChartHTML = X, b.getSVG = Z, b.getSVGForExport = aa, b.getFilename = Y, b.moveContainers = ea, b.beforePrint = S, b.contextMenu = U, b.addButton = z, b.destroyExport = V, b.renderExporting = ia, b.callbacks.push(T), t(a, "init", fa), c.isSafari && c.win.matchMedia("print").addListener(function (a) {
