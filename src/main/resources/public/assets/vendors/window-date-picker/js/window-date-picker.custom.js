      ...
      function () {
        ...
        function WindowDatePicker(opt) {
          ...
          if (this.type != DATE) {
            ...
            Util.addEventListener(this.els.hourContainer.querySelector('.wdp-hour-arrow-container > div:nth-child(' + hourIndex + ') > svg'), [Util.MOUSE_DOWN], function (e) {
              e.preventDefault();
              if (_this.orientation) _this.setHour(_this.value.hour + 1);else _this.setHour(_this.value.hour - 1);
            });
            Util.addEventListener(this.els.hourContainer.querySelector('.wdp-hour-el-container + .wdp-hour-arrow-container > div:nth-child(' + hourIndex + ') > svg'), [Util.MOUSE_DOWN], function (e) {
              e.preventDefault();
              if (!_this.orientation) _this.setHour(_this.value.hour + 1);else _this.setHour(_this.value.hour - 1);
            });
            this.els.minuteInput = this.els.hourContainer.querySelector('.wdp-hour-el-container > input:nth-child(' + minuteIndex + ')');
            ...
            Util.addEventListener(this.els.hourContainer.querySelector('.wdp-hour-arrow-container > div:nth-child(' + minuteIndex + ') > svg'), [Util.MOUSE_DOWN], function (e) {
              e.preventDefault();
              if (_this.orientation) _this.setMinute(_this.value.minute + 1);else _this.setMinute(_this.value.minute - 1);
            });
            Util.addEventListener(this.els.hourContainer.querySelector('.wdp-hour-el-container + .wdp-hour-arrow-container > div:nth-child(' + minuteIndex + ') > svg'), [Util.MOUSE_DOWN], function (e) {
              e.preventDefault();
              if (!_this.orientation) _this.setMinute(_this.value.minute + 1);else _this.setMinute(_this.value.minute - 1);
            });

            if (this.hourType == $12) {
              this.els.amInput = this.els.hourContainer.querySelector('.wdp-hour-el-container > input:nth-child(' + ampmIndex + ')');
              ...
              Util.addEventListener(this.els.hourContainer.querySelector('.wdp-hour-arrow-container > div:nth-child(' + ampmIndex + ') > svg'), [Util.MOUSE_DOWN], function (e) {
                e.preventDefault();

                _this.setAM(!_this.value.am);
              });
              Util.addEventListener(this.els.hourContainer.querySelector('.wdp-hour-el-container + .wdp-hour-arrow-container > div:nth-child(' + ampmIndex + ') > svg'), [Util.MOUSE_DOWN], function (e) {
                e.preventDefault();
        ...
        _createClass(WindowDatePicker, [{
          ...
          value: function getValueText(value) {
            ...
            if (this.type != HOUR) {
              if (this.dateType == DMY) {
                ...
                txt = "".concat(value.year, "-").concat(Util.renderNumber(value.day), "-").concat(Util.renderNumber(value.month));
              } else {
                txt = "".concat(value.year, "-").concat(Util.renderNumber(value.month), "-").concat(Util.renderNumber(value.day));
              }
            }
          ...
          value: function setSpanText() {
            ...
            if (v.value == '' && this.type != HOUR) {
              ...
              this.els.span.innerHTML = displaySpanText;
            }
          }
          /**
           * Sets date span text.
          ...
          value: function setDateSpanText() {
            ...
            if (this.datePage == MONTH) {
              if (this.dateType == DMY || this.dateType == MDY) {
                ...
                val = "".concat(this.tmpValue.year, " ").concat(this.LANG.MONTHS[this.tmpValue.month]);
              }
