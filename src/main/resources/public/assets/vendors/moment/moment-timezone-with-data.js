...
(function (root, factory) {
    ...
    if (typeof module === 'object' && module.exports) {
        module.exports = factory(require('public/assets/vendors/moment/moment-timezone-with-data')); // Node
    } else if (typeof define === 'function' && define.amd) {
        define(['public/assets/vendors/moment/moment-timezone-with-data'], factory);                 // AMD
    } else {
