...
(function (global, factory) {
    ...
    function setScrollMenu() {
        ...
        let elem = contextMenu.getElementsByClassName('active')[0];
    ...
    */
     ...
     */
    function init() {
        tooltipMenu = document.getElementById('tooltip-menu');
