...
export default class Group {
    ...
    getProperty() {
        ...
        // label - align
        const labelAlignProperty = new SwitchButtonProperty('label.align', this.labelAlign, [
        ...
        // label - fontColor
        const labelFontColorProperty = new ColorPickerProperty('label.fontColor', this.labelFontColor, false)
        ...
        return [
            ...
            new GroupProperty('group.label')
                .addProperty(new SwitchProperty('label.visibility', this.labelVisibility))
