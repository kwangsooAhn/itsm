...
class ZFormButton {
    ...
    makeDefaultButton() {
        ...
        // 닫기 버튼
        const UICloseButton = new UIButton(i18n.msg('common.btn.close')).addUIClass('btn--theme-secondary')
        ...
        if (this.isToken) {
            // 프로세스 맵 버튼
            const UIProcessMapButton = new UIButton(i18n.msg('token.label.processMap')).addUIClass('btn--theme-secondary')
                .onUIClick(this.zForm.openProcessStatusModal.bind(this.zForm));
            UIButtonGroup.addUI(UIProcessMapButton);

            // 인쇄 버튼
            const UIPrintButton = new UIButton(i18n.msg('common.btn.print')).addUIClass('btn--theme-secondary')
    ...
    makeReturnButton() {
        ...
        // 돌아가기 버튼
        const UIReturnButton = new UIButton(i18n.msg('common.btn.return')).addUIClass('btn--theme-secondary')
    ...
    makeActionButton(actions) {
        ...
        // 버튼 목록 생성
        const UIButtonTopGroup = new UIDiv().setUIClass('btn__list').addUIClass('justify-content-end');
        // 동적 버튼
        actions.forEach( (btn) => {
