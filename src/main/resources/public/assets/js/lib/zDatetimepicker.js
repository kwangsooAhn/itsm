...
(function(global, factory) {
    ...
    function Picker(options) {
        ...
        buttonRemove.className = 'btn__ic theme--extra';
        ...
        if (this.type === 'DATEHOUR' || this.type === 'HOUR') {
            ...
            buttonConfirm.className = 'btn__text--box theme--secondary';
            ...
            buttonCancel.className = 'btn__text--box theme--extra';
        ...
        if (this.type === 'YEAR') {
            ...
            buttonReset.className = 'btn__text--box theme--extra theme--small';
