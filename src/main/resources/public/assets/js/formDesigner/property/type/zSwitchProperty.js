...
export default class ZSwitchProperty extends ZProperty {
    ...
    makeProperty(panel) {
        ...
        // 툴팁(도움말) 기능 추가
        if (this.help !== '') {
            this.UIElement.UISwitch.UITooltip = new UIDiv().setUIClass('z-help-tooltip');
            this.UIElement.UISwitch.UITooltip.addUI(new UISpan().setUIClass('z-icon').addUIClass('i-tooltip'));
            this.UIElement.UISwitch.UITooltip.UIContent = new UIDiv().setUIClass('z-tooltip-contents');
