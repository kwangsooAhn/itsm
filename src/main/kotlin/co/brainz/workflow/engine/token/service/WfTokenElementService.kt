...
import co.brainz.workflow.engine.token.service.updatetoken.WfUpdateTokenService
...
class WfTokenElementService(
    ...
    private val wfUpdateTokenService: WfUpdateTokenService
) {
    ...
    fun setTokenAction(wfTokenDto: WfTokenDto) {
        wfUpdateTokenService.updateTokenAction(wfTokenDto)
    }
}
