...
object RestTemplateConstants {
    ...
    enum class Workflow(val url: String, val method: String) {
        ...
        GET_DOCUMENTS_DISPLAY("/rest/wf/documents/{documentId}/data", "GET"),
        POST_DOCUMENTS_DISPLAY("/rest/wf/documents/{documentId}/data", "POST"),
        PUT_DOCUMENTS_DISPLAY("/rest/wf/documents/{documentId}/data", "PUT"),
