...
class WfInstanceService(
    ...
    private val wfTokenMapper: WfTokenMapper = Mappers.getMapper(
        WfTokenMapper::class.java
    )
    private val wfCommentMapper: WfCommentMapper = Mappers.getMapper(
        WfCommentMapper::class.java
    )
    ...
    fun createInstance(restTemplateTokenDto: RestTemplateTokenDto): WfInstanceEntity {
        ...
        val user = restTemplateTokenDto.assigneeId?.let { aliceUserRepository.findByUserKey(it) }
