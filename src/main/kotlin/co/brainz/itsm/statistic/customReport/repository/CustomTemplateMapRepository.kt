...
@Repository
interface CustomTemplateMapRepository : JpaRepository<ReportTemplateMapEntity, String> {
    fun deleteReportTemplateMapEntityByTemplate(templateEntity: CustomTemplateEntity)
}
