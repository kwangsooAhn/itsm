...
class Pie(
    ...
    override fun percent(chartConfig: co.brainz.itsm.report.chart.dto.ChartConfig, category: LinkedHashSet<String>, tagInstance: List<ChartTagInstanceDto>): List<ChartData> {
