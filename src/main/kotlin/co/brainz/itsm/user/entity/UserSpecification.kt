 ...
 */
class UserSpecification(private val codeEntity: List<CodeEntity>, private val searchValue: String) : Specification<AliceUserEntity> {
    ...
    override fun toPredicate(root: Root<AliceUserEntity>, query: CriteriaQuery<*>, criteriaBuilder: CriteriaBuilder): Predicate? {
        ...
        codeEntity.forEach {
            ...
            if (tableColumn != "") {
                predicate.add(criteriaBuilder.like(criteriaBuilder.lower(root.get<String>(tableColumn)), "%$searchValue%"))
            }
        }
