...
insert into awf_url values ('/charts/basicChart/search', 'get', '기본차트 조회 리스트 화면', 'TRUE');
insert into awf_url values ('/charts/customChart', 'get', '사용자 정의 차트 목록', 'TRUE');
insert into awf_url values ('/charts/customChart/search', 'get', '사용자 정의 차트 목록 조회 화면', 'TRUE');
insert into awf_url values ('/charts/customChart/new', 'get', '사용자 정의 차트 등록 화면', 'TRUE');
insert into awf_url values ('/charts/customChart/{id}/edit', 'get', '사용자 정의 차트 수정 화면', 'TRUE');
insert into awf_url values ('/charts/customChart/{id}/view', 'get', '사용자 정의 차트 조회 화면', 'TRUE');
insert into awf_url values ('/charts/customChart/{id}/preview', 'get', '사용자 정의차트 미리보기', 'TRUE');
...
insert into awf_url values ('/dashboards/dashboardTemplate/search', 'get', '현황판 템플릿 조회 리스트 화면', 'TRUE');
insert into awf_url values ('/dashboards/dashboardManagement/edit', 'get', '개인 현황판 관리 화면', 'TRUE');
...
insert into awf_url values ('/reports/basicReport/search', 'get', '기본보고서 조회 리스트 화면', 'TRUE');
insert into awf_url values ('/reports/customReport', 'get', '보고서 조회', 'TRUE');
insert into awf_url values ('/reports/customReport/search', 'get', '보고서 조회 검색 화면 호출', 'TRUE');
insert into awf_url values ('/reports/customReport/{id}/view', 'get', '보고서 상세화면', 'TRUE');
insert into awf_url values ('/reports/customTemplate', 'get', '템플릿 설정 목록 조회', 'TRUE');
insert into awf_url values ('/reports/customTemplate/new', 'get', '템플릿 설정 등록', 'TRUE');
insert into awf_url values ('/reports/customTemplate/preview', 'get', '템플릿 미리보기', 'true');
insert into awf_url values ('/reports/customTemplate/search', 'get', '템플릿 설정 검색 화면 호출', 'TRUE');
insert into awf_url values ('/reports/customTemplate/{id}/edit', 'get', '템플릿 설정 수정', 'TRUE');
insert into awf_url values ('/reports/customTemplate/{id}/view', 'get', '템플릿 설정 미리보기', 'TRUE');
...
insert into awf_url values ('/rest/charts/customChart', 'post', '사용자 정의 차트 등록', 'TRUE');
insert into awf_url values ('/rest/charts/customChart/{id}', 'get', '사용자 정의 차트 미리보기');
insert into awf_url values ('/rest/charts/customChart/{id}', 'put', '사용자 정의 차트 수정', 'TRUE');
insert into awf_url values ('/rest/charts/customChart/{id}', 'delete', '사용자 정의 차트 삭제', 'TRUE');
insert into awf_url values ('/rest/charts/customChart/{id}/preview', 'post', '사용자 정의 차트 미리보기', 'TRUE');
...
insert into awf_url values ('/rest/reports/customTemplate', 'post', '템플릿 설정 등록 처리', 'true');
insert into awf_url values ('/rest/reports/customTemplate/charts', 'get', '템플릿 차트 데이터 조회', 'true');
insert into awf_url values ('/rest/reports/customTemplate/{id}', 'delete', '템플릿 설정 삭제 처리', 'true');
insert into awf_url values ('/rest/reports/customTemplate/{id}', 'post', '보고서 생성 (임시)', 'true');
insert into awf_url values ('/rest/reports/customTemplate/{id}', 'put', '템플릿 설정 수정 처리', 'true');
