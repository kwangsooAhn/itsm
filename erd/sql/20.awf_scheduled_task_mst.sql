...
insert into awf_scheduled_task_mst values ('4028b2647fbed869039fdce4cf870321', 'IF 모니터링 플러그인 연동', 'jar', 'IF 모니터링 플러그인 연동을 통해 rest API 통신을 진행한다.', 'TRUE', 'FALSE', null, null, 'java -jar ifMonitoring.jar', 'cron', null, '0 0/5 * * * ?', null, '/ifMonitoring', '0509e09412534a6e98f04ca79abb6424', now(), null, null);