...
insert into awf_menu values ('report.customTemplate', 'report', '/reports/customTemplate/search', 1, 'TRUE');
insert into awf_menu values ('report.customReport', 'report', '/reports/customReport/search', 2, 'TRUE');
insert into awf_menu values ('report.basicReport', 'report', '/reports/basicReport/search', 3, 'TRUE');
insert into awf_menu values ('report.customChart', 'report', '/charts/customChart/search', 4, 'TRUE');
insert into awf_menu values ('report.basicChart', 'report', '/charts/basicChart/search', 5, 'TRUE');
insert into awf_menu values ('report.dashboardTemplate', 'report', '/dashboards/dashboardTemplate/search', 6, 'TRUE');
insert into awf_menu values ('report.dashboardManagement', 'report', '/dashboards/dashboardManagement/edit', 7, 'TRUE');
