...
insert into awf_url_auth_map values ('/rest/sla/metrics/years/{id}/preview', 'get', 'sla.manage');
insert into awf_url_auth_map values ('/rest/sla/metrics/years/{id}/preview', 'get', 'sla.view');
