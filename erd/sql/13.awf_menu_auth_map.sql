...
insert into awf_menu_auth_map values ('report.basicReport', 'report.view');
insert into awf_menu_auth_map values ('report.basicChart', 'report.view');
insert into awf_menu_auth_map values ('report.customChart', 'report.manage');
insert into awf_menu_auth_map values ('report.customChart', 'report.view');
insert into awf_menu_auth_map values ('report.customReport', 'report.manage');
insert into awf_menu_auth_map values ('report.customReport', 'report.view');
insert into awf_menu_auth_map values ('report.customTemplate', 'report.manage');
insert into awf_menu_auth_map values ('report.dashboardTemplate', 'report.view');
insert into awf_menu_auth_map values ('report.dashboardManagement', 'report.view');
