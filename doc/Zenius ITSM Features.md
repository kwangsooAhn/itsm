...
| 기능명 | 기능설명 | 적용버전 | 진행일감 |
|---|:---|:----:|:---:|
| 일반 회원가입 | ITSM 사이트에서 개인정보를 입력하여 회원가입을 할 수 있다. | 3.0| - |
| 소셜 회원가입 | 구글 / 카카오를 통해 간편가입이 가능하다. | 3.0| - |
| 일반 로그인 | ITSM 사이트를 통해 가입한 정보로 로그인 할 수 있다. | 3.0  | - |
| 소셜 로그인 | 소셜 회원가입을 통해 가입한 정보로 로그인 할 수 있다. | 3.0  | - |
