...
|서비스 카테고리 관리|서비스의 정보를 상세 조회하고 서비스 코드, 서비스 이름으로 검색할 수 있다.|3.1|#13368|
...
| 기능명 | 기능설명 | 적용버전 | 진행일감 |
|---|:---|:----:|:---:|
| 일반 회원가입 | ITSM 사이트에서 개인정보를 입력하여 회원가입을 할 수 있다. | 3.1| #13432 |
| 소셜 회원가입 | 구글 / 카카오를 통해 간편가입이 가능하다. | 3.1| #13432 |
| 일반 로그인 | ITSM 사이트를 통해 가입한 정보로 로그인 할 수 있다. | 3.1  | #13432 |
| 소셜 로그인 | 소셜 회원가입을 통해 가입한 정보로 로그인 할 수 있다. | 3.1  | #13432 |
| 로그인 세션 유지 | 로그인 세션 유지 선택시, 사용자가 로그아웃을 하기 전까지 세션이 유지된다. | 3.1  | #13432 |
| 비밀번호 찾기 | 기존의 패스워드를 초기화한 후, 랜덤하게 생성된 패스워드를 가입시 작성한 이메일로 전송한다. | 3.1| #13432 |